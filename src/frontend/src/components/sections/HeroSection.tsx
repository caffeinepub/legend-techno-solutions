...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: 'url(/assets/generated/legend-techno-hero-bg.dim_1600x900.png)',
      ...
      <div className="container relative z-10 py-20">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-600/10 border border-amber-600/20">
            ...
            <span className="text-sm font-medium text-amber-600">Professional Tech Services</span>
          </div>

          <h1 className="text-4xl md:text-6xl font-bold text-foreground leading-tight">
            Expert Solutions for All Your{' '}
            <span className="text-amber-600">Tech Needs</span>
          </h1>

          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            From computer repairs to CCTV installations, we provide reliable, professional services
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="text-lg px-8 border-amber-600/30 hover:bg-amber-600/10"
            >
